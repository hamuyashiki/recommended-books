...
buttonSelfComment.click(function () {
  var recommendId = buttonSelfComment.data('recommend-id');
  var categoryId = buttonSelfComment.data('category-id');
  var bookName = buttonSelfComment.data('book-name'); // const postedBy = req.user.id;  // ダメ
  ...
  if (comment) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/recommendations/".concat(categoryId, "/").concat(bookName, "/comments"), {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-postedBy').text(userId);
